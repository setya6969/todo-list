@extends('layout')
@section('container')
<div class="h-auto w-full pt-[100px] px-[92px]">
        ...
        <form action="#" method="post" class="flex flex-col space-y-8">
            <div class="bg-white px-[77px] py-[30px] text-center rounded-[20px]">
                ...
                <div class="mt-14 flex justify-center space-x-6">
                    <div>
                        <button onclick="location.href='{{url('editor/download')}}'" class="font-bold text-white bg-red-500 px-20 py-2 rounded-[10px] capitalize">download</button>
                    </div>
                    <div>
                        {{-- <label for="status" class="font-bold text-white bg-blue-500 px-20 py-2 rounded-[10px] capitalize">pilih status</label> --}}
                        <select name="status" class="py-2 px-14 rounded-[10px] capitalize bg-orange-400 text-white font-semibold cursor-pointer">
                            <option class="bg-white capitalize" selected>pilih status</option>
                            <option class="capitalize" value="">revisi</option>
                            <option class="capitalize" value="">terverifikasi</option>
                        </select>
                    </div>     
                </div>
            </div>
            ...
            <div>
                <button type="submit" class="float-right px-20 py-2 rounded-xl mb-5 bg-black text-orange-400">Submit</button>
            </div>
        </form>
    </div>
</div>
